component {
    ...
    public picture function upload() {
        ...
        var gallery = createObject("component", "API.com.IcedReaper.gallery.gallery").init(variables.galleryId);
        ...
        imageFunctionCtrl.resize(gallery.getAbsolutePath() & "/" & newFilename, 575, gallery.getAbsolutePath() & "/tn_" & newFilename);
