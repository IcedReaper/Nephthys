component {
    ...
    public user function getCreator() {
        if(! vairables.keyExists("creator")) {
            variables.creator = createObject("component", "API.com.Nephthys.classes.user").init(variables.creatorUserId);
        }
    ...
    public user function getLastEditor() {
        if(! vairables.keyExists("lastEditor")) {
            variables.lastEditor = createObject("component", "API.com.Nephthys.classes.user").init(variables.lastEditorUserId);
        }
