angular.module("com.nephthys.page.statistics", ["chart.js",
    ...
    .service("comNephthysPageStatisticsService", function($http) {
        return {
            getPageRequests: function(sortOrder, fromDate, toDate, pageId) {
                return $http.get('/ajax/com/Nephthys/pageManager/getPageRequests', {
                    params: {
                        pageId:    pageId,
                        sortOrder: sortOrder,
            ...
            getPageRequestsSeparatedByPage: function(sortOrder, fromDate, toDate) {
                return $http.get('/ajax/com/Nephthys/pageManager/getPageRequestsSeparatedByPage', {
                    params: {
                        sortOrder: sortOrder,
                        fromDate:  fromDate.toAjaxFormat(),
                        toDate:    toDate.toAjaxFormat()
            ...
            getPageRequestsSeparatedByLink: function(sortOrder, fromDate, toDate, pageId) {
                return $http.get('/ajax/com/Nephthys/pageManager/getPageRequestsSeparatedByLink', {
                    params: {
                        pageId:    pageId,
                        sortOrder: sortOrder,
                        fromDate:  fromDate.toAjaxFormat(),
    ...
    .directive("nephthysPageStatistics", function() {
        return {
            ...
            templateUrl : "/themes/default/modules/com/Nephthys/pageManager/directives/statistics/statistics.html"
        };
    });