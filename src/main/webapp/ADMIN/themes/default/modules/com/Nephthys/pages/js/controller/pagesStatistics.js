nephthysAdminApp
    .controller('pagesStatisticsCtrl', ["$scope", "$routeParams", "$uibModal", "visitService", function ($scope, $routeParams, $uibModal, visitService) {
        ...
        $scope.refresh = function () {
            ...
            visitService
                .getPageRequests($routeParams.pageId,
        ...
        $scope.openDatePickerDialog = function () {
            $uibModal.open({
                ...
                templateUrl:    "/themes/default/modules/com/Nephthys/pages/partials/datePickerModal.html",
