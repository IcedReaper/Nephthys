angular.module("com.Nephthys.userManager.statistics", ["chart.js",
    ...
    .service("comNephthysUserStatisticsService", function($http) {
        return {
            getLoginStatistics: function(sortOrder, fromDate, toDate, userId) {
                return $http.get('/ajax/com/Nephthys/userManager/getLoginStatisticsTotal', {
                    params: {
                        userId:    userId,
                        sortOrder: sortOrder,
    ...
    .directive("nephthysUserStatistics", function() {
        return {
            ...
            templateUrl : "/themes/default/modules/com/Nephthys/userManager/directives/statistics/statistics.html"
        };
    });